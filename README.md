...
This repository hosts the generated OpenGL 4.1 binding for Erlang and
...
[API reference](https://erlangsters.github.io/opengl-4.1/), and the
...
dep_gl = git https://github.com/erlangsters/opengl-4.1 master
```
